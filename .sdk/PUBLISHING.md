...
|---|---|---|
| `ts/` | @voxgig-sdk/forzamusic-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/forzamusic-sdk \
      --repository voxgig-sdk/forzamusic-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/forzamusic-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/forzamusic-sdk --id=<id>` removes one.
