...
class ForzamusicProxyFeature extends ForzamusicBaseFeature
{
    ...
    public function init(ForzamusicContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ForzamusicContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
