...
// Forzamusic SDK ratelimit feature
...
class ForzamusicRatelimitFeature extends ForzamusicBaseFeature
{
    ...
    private function _acquire(ForzamusicContext $ctx): void
    {
    ...
    private function _track(ForzamusicContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
