...
// Forzamusic SDK streaming feature
...
class ForzamusicStreamingFeature extends ForzamusicBaseFeature
{
    ...
    private function _iterate(ForzamusicResult $result): \Generator
    {
    ...
    private function _streamable(ForzamusicContext $ctx): bool
    {
