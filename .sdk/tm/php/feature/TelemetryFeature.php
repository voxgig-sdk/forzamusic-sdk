...
// Forzamusic SDK telemetry feature
...
class ForzamusicTelemetryFeature extends ForzamusicBaseFeature
{
    ...
    private function _close(ForzamusicContext $ctx, bool $ok): void
    {
