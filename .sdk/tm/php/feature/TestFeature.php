...
// Forzamusic SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ForzamusicTestFeature extends ForzamusicBaseFeature
{
    ...
    public function init(ForzamusicContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ForzamusicContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = ForzamusicParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ForzamusicContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ForzamusicContext $ctx, $op, $args): array
    {
