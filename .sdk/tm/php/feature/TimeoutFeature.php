...
// Forzamusic SDK timeout feature
...
class ForzamusicTimeoutFeature extends ForzamusicBaseFeature
{
    ...
    private function _with_timeout(ForzamusicContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ForzamusicContext $_ctx, float $ms): void
    {
        $client = $this->client;
