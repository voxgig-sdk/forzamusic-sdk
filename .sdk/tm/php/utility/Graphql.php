...
// Forzamusic SDK utility: graphql
//
...
class ForzamusicGraphql
{
    ...
    // equivalent.
    public static function body(ForzamusicContext $ctx): mixed
    {
    ...
    public static function errors(ForzamusicContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
