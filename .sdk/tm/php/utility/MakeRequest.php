...
// Forzamusic SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ForzamusicMakeRequest
{
    public static function call(ForzamusicContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ForzamusicResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ForzamusicResponse($fetched);
        } else {
