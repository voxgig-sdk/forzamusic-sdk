...
from projectname_sdk.core.control import ForzamusicControl
...
class ForzamusicContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, ForzamusicSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ForzamusicResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ForzamusicResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ForzamusicError(code, msg, self)
