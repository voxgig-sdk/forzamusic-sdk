...
from projectname_sdk import ForzamusicSDK
from projectname_sdk.core.spec import ForzamusicSpec
from projectname_sdk.core.result import ForzamusicResult
from projectname_sdk.core.response import ForzamusicResponse
from projectname_sdk.core.operation import ForzamusicOperation
from projectname_sdk.core.error import ForzamusicError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import ForzamusicBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return ForzamusicError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = ForzamusicSDK.test(None, None)
        ...
        class TestInitFeature(ForzamusicBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(ForzamusicBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = ForzamusicSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = ForzamusicSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = ForzamusicSDK.test(None, setup_opts)
