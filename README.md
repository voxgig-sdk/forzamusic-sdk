...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/forzamusic` | `npm install @voxgig-sdk/forzamusic` |
| Python | `voxgig-sdk-forzamusic` | `pip install voxgig-sdk-forzamusic` |
| PHP | `voxgig-sdk/forzamusic` | `composer require voxgig-sdk/forzamusic` |
| Golang | `github.com/voxgig-sdk/forzamusic-sdk/go` | `go get github.com/voxgig-sdk/forzamusic-sdk/go` |
| Ruby | `voxgig-sdk-forzamusic` | `gem install voxgig-sdk-forzamusic` |
| Lua | `voxgig-sdk-forzamusic` | `luarocks install voxgig-sdk-forzamusic` |
