...
AQL-driven CLI and REPL for the Forzamusic SDK. Positional arguments are
...
./forzamusic-cli list album
./forzamusic-cli load 1 album
./forzamusic-cli load '{id:1}' album
