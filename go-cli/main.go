// Command Forzamusic-cli is a CLI + REPL for the Forzamusic SDK,
...
const prompt = "forzamusic"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "album lyric search song"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      FORZAMUSIC_APIKEY (api key), FORZAMUSIC_BASE (base url override)")
