...
func registerSDKWords(r *eng.Registry, client *sdk.ForzamusicSDK) {
...
func runOp(client *sdk.ForzamusicSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
