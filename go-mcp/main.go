// Command Forzamusic-mcp is an MCP server exposing the Forzamusic
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Forzamusic_list  — list records of an entity
//	Forzamusic_load  — load a single record of an entity
//
