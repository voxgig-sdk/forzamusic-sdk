...
The Golang SDK for the Forzamusic API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/forzamusic-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/forzamusic-sdk=../path/to/github.com/voxgig-sdk/forzamusic-sdk
```
...
| `Album` | `(data map[string]any) ForzamusicEntity` | Create a Album entity instance. |
...
```
github.com/voxgig-sdk/forzamusic-sdk/
...
The root package (`github.com/voxgig-sdk/forzamusic-sdk`) re-exports everything needed
