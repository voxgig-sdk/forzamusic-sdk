...
type LyricEntity struct {
	name    string
	client  *core.ForzamusicSDK
...
func NewLyricEntity(client *core.ForzamusicSDK, entopts map[string]any) *LyricEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LyricEntity) GetName() string { return e.name }
...
func (e *LyricEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LyricEntity) Deleted() bool {
	return e.deleted
}


func (e *LyricEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLyricEntity(e.client, opts)
}

func (e *LyricEntity) Data(args ...any) any {
...
func (e *LyricEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Lyric; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LyricEntity) DataTyped(data ...Lyric) Lyric {
	if len(data) > 0 {
		return typedFrom[Lyric](e.Data(asMap(data[0])))
	}
	return typedFrom[Lyric](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Lyric (all fields
// optional at the wire level).
func (e *LyricEntity) MatchTyped(match ...Lyric) Lyric {
	if len(match) > 0 {
		return typedFrom[Lyric](e.Match(asMap(match[0])))
	}
	return typedFrom[Lyric](e.Match())
}
...
func (e *LyricEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LyricEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LyricLoadMatch and returns an Lyric. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *LyricEntity) LoadTyped(reqmatch LyricLoadMatch, ctrl map[string]any) (Lyric, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Lyric{}, err
	}
	return typedFrom[Lyric](res), nil
}



func (e *LyricEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *LyricEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LyricEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LyricEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LyricEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
