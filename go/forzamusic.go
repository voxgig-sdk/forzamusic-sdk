...
// instead of `sdk.NewForzamusicSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *ForzamusicSDK  { return NewForzamusicSDK(nil) }
func Test() *ForzamusicSDK { return TestSDK(nil, nil) }
