...
const testSeed = `map[string]any{"entity": map[string]any{"album": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "lyric": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "song": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
