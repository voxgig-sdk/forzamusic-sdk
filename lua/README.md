...
The Lua SDK for the Forzamusic API. Provides an entity-oriented interface using Lua conventions.
...
local result, err = client:Forzamusic(nil):load(
  { id = "test01" }, nil
)
...
The main module (`forzamusic_sdk`) exports the SDK constructor
