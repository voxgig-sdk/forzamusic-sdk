...
local ForzamusicSDK = {}
ForzamusicSDK.__index = ForzamusicSDK
...
ForzamusicSDK._make_feature = _make_feature


function ForzamusicSDK.new(options)
  local self = setmetatable({}, ForzamusicSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function ForzamusicSDK:options_map()
...
function ForzamusicSDK:get_utility()
  return Utility.copy(self._utility)
end


function ForzamusicSDK:get_root_ctx()
  return self._rootctx
end


function ForzamusicSDK:prepare(fetchargs)
...
function ForzamusicSDK:direct(fetchargs)
...
-- by passing it.
function ForzamusicSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function ForzamusicSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "ForzamusicSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function ForzamusicSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = ForzamusicSDK.new(sdkopts)
  sdk.mode = "test"
