...
class ForzamusicCacheFeature extends ForzamusicBaseFeature
{
    ...
    private function _through(ForzamusicContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
