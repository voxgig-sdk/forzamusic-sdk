...
// Forzamusic SDK clienttrack feature
...
class ForzamusicClienttrackFeature extends ForzamusicBaseFeature
{
    ...
    public function PostConstruct(ForzamusicContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Forzamusic-SDK';
