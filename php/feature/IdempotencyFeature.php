...
// Forzamusic SDK idempotency feature
...
class ForzamusicIdempotencyFeature extends ForzamusicBaseFeature
{
    ...
    private function _mutating(ForzamusicContext $ctx): bool
    {
