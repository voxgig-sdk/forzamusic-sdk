...
class ForzamusicRbacFeature extends ForzamusicBaseFeature
{
    ...
    private function _required(ForzamusicContext $ctx): ?string
    {
    ...
    private function _reject(ForzamusicContext $ctx, string $required): void
    {
    ...
    private function _track(ForzamusicContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
