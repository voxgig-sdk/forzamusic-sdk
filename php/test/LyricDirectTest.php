...
class LyricDirectTest extends TestCase
{
    public function test_direct_load_lyric(): void
    {
        $setup = lyric_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-lyric", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
