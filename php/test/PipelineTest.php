...
{
    private static function utility(): ForzamusicUtility
    {
        return new ForzamusicUtility();
    }
    ...
    private static function ctx(array $over = []): ForzamusicContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ForzamusicContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ForzamusicOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ForzamusicError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ForzamusicOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ForzamusicMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ForzamusicOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ForzamusicMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ForzamusicOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ForzamusicMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ForzamusicSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ForzamusicMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ForzamusicResponse([]),
            'result' => new ForzamusicResult([]),
        ]);
        [, $err] = ForzamusicMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ForzamusicSpec([]),
            'response' => null,
            'result' => new ForzamusicResult([]),
        ]);
        [, $err] = ForzamusicMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ForzamusicSpec(['step' => 's']),
            'response' => new ForzamusicResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ForzamusicResult([]),
        ]);
        [, $err] = ForzamusicMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ForzamusicSpec(['step' => 's']),
            'response' => new ForzamusicResponse(self::resp(200, ['v' => 1])),
            'result' => new ForzamusicResult([]),
        ]);
        [, $err] = ForzamusicMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ForzamusicSpec(['step' => 's']),
            'response' => new ForzamusicResponse(self::resp(200, ['v' => 2])),
            'result' => new ForzamusicResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ForzamusicMakeResponse::call($ctx);
    ...
    {
        $preset = new ForzamusicResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ForzamusicSpec([]),
            'response' => new ForzamusicResponse([]),
            'result' => new ForzamusicResult([]),
        ...
        [$got, $err] = ForzamusicMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ForzamusicResult([])]);
        [, $err] = ForzamusicMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ForzamusicSpec([]), 'result' => null]);
        [, $err] = ForzamusicMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ForzamusicSpec(['step' => 's']),
            'result' => new ForzamusicResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ForzamusicOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ForzamusicMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ForzamusicSpec(['step' => 's']),
            'result' => new ForzamusicResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ForzamusicOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ForzamusicMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ForzamusicResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ForzamusicSpec([]),
            'result' => new ForzamusicResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ForzamusicMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ForzamusicMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ForzamusicError('boom', 'boom');
        $utility->fetcher = function (ForzamusicContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ForzamusicSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ForzamusicMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ForzamusicContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ForzamusicMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ForzamusicResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ForzamusicMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ForzamusicContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ForzamusicSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ForzamusicMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ForzamusicResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ForzamusicSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ForzamusicMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ForzamusicMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ForzamusicMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ForzamusicResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ForzamusicDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ForzamusicResult(['ok' => false])]);
        $this->expectException(ForzamusicError::class);
        ForzamusicDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ForzamusicResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ForzamusicMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ForzamusicMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ForzamusicBaseFeature();
        $b = new ForzamusicBaseFeature();
        ForzamusicFeatureAdd::call($ctx, $a);
        ForzamusicFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ForzamusicBaseFeature
    {
        $f = new ForzamusicBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ForzamusicFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?ForzamusicSpec $spec): ForzamusicContext
    {
    ...
    private static function auth_bags(): ForzamusicSpec
    {
        return new ForzamusicSpec(['headers' => [], 'query' => []]);
    }
    ...
    private static function auth_probe(array $options): ?array
    {
        ...
        ForzamusicPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ForzamusicPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ForzamusicResponse(['headers' => null]),
            'result' => new ForzamusicResult([]),
        ]);
        ForzamusicResultHeaders::call($ctx);
