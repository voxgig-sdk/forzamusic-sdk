...
// Forzamusic SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ForzamusicSDK::test)
...
{
    private const SDK_CLASS = 'ForzamusicSDK';
    ...
    private const SDK_BASE = 'forzamusic_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../forzamusic_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
