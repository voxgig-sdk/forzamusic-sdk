...
class ForzamusicTestRunner
{
    ...
    {
        $live = self::getenv('FORZAMUSIC_TEST_LIVE');
        $override = self::getenv('FORZAMUSIC_TEST_OVERRIDE');
        ...
        $explain = self::getenv('FORZAMUSIC_TEST_EXPLAIN');
...
class_alias('ForzamusicTestRunner', 'Runner');
class_alias('ForzamusicHelpers', 'Helpers');
