...
class ForzamusicFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ForzamusicSDK/1.0)';
    ...
    public static function call(ForzamusicContext $ctx, string $fullurl, array $fetchdef): array
    {
