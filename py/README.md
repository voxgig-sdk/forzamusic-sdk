# Forzamusic Python SDK

The Python SDK for the Forzamusic API. Provides an entity-oriented interface following Pythonic conventions.
...
result, err = client.Forzamusic(None).load(
    {"id": "test01"}, None
)
...
```
py/
├── forzamusic_sdk.py         -- Main SDK module
