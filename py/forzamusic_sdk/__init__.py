...
from forzamusic_sdk.utility import register

# Load features
from forzamusic_sdk.feature.base_feature import ForzamusicBaseFeature
from forzamusic_sdk.features import _has_feature, _make_feature
...
class ForzamusicSDK:
    ...
    def get_utility(self):
        return ForzamusicUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ForzamusicSDK: graphql: " + str(msg))
            res["graphql"] = errors
