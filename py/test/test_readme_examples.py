# Forzamusic SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ForzamusicSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ForzamusicSDK(...) and ForzamusicSDK.test(...) become
#      ForzamusicSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "forzamusic_sdk"
_SDK_CLASS = "ForzamusicSDK"
