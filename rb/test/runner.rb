...
module ForzamusicTestRunner
  ...
  def self.env_override(m)
    live = getenv("FORZAMUSIC_TEST_LIVE")
    override = getenv("FORZAMUSIC_TEST_OVERRIDE")
    ...
    explain = getenv("FORZAMUSIC_TEST_EXPLAIN")
    m["FORZAMUSIC_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = ForzamusicTestRunner
Helpers = ForzamusicHelpers
Vs = VoxgigStruct
