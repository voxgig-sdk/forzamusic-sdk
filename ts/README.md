# Forzamusic TypeScript SDK



The TypeScript SDK for the Forzamusic API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Album()` — each with a small set of operations (`list`, `load`)
...
| `tester(testopts?, sdkopts?)` | `ForzamusicSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `ForzamusicSDK.test(testopts?, sdkopts?)` | `ForzamusicSDK` | Create a test-mode client. |
...
| `client` | `client(): ForzamusicSDK` | Return the parent SDK client. |
...
forzamusic/
├── src/
│   ├── ForzamusicSDK.ts        # Main SDK class
