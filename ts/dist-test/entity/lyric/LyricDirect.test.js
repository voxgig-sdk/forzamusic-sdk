...
(0, node_test_1.describe)('LyricDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ForzamusicSDK({
    ...
    (0, node_test_1.test)('direct-load-lyric', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-lyric', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.FORZAMUSIC_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ForzamusicSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['FORZAMUSIC_TEST_LYRIC_ENTID'];
    ...
    const client = new __1.ForzamusicSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=LyricDirect.test.js.map