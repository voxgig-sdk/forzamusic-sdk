...
function envOverride(m) {
    if ('TRUE' === process.env.FORZAMUSIC_TEST_LIVE ||
        'TRUE' === process.env.FORZAMUSIC_TEST_OVERRIDE) {
    ...
    m.FORZAMUSIC_TEST_EXPLAIN = process.env.FORZAMUSIC_TEST_EXPLAIN || m.FORZAMUSIC_TEST_EXPLAIN;
    return m;
}
